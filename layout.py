...
if __name__ == "__main__" :
    ...
    gui.title("Religious Sentiment Detector")
    ...
    enterText.grid(row = 0, column = 6)
     
    textArea.grid(row = 1, column = 6, padx = 10, sticky = W)
     
    check.grid(row = 2, column = 6)
     
    negative.grid(row = 3, column = 6)
     
    neutral.grid(row = 5, column = 6)
     
    positive.grid(row = 7, column = 6)
     
    overall.grid(row = 9, column = 6)
     
    negativeField.grid(row = 4, column = 6)
 
    neutralField.grid(row = 6, column = 6)
                       
    positiveField.grid(row = 8, column = 4)
     
    overallField.grid(row = 10, column = 6)
     
    clear.grid(row = 11, column = 6)
     
    Exit.grid(row = 12, column = 6)
